Shader "Retro/PSX_VertexSnap_Glass_Refraction_Blink_URP"
{
    Properties
    {
        ...
        _BlinkSpeed ("Blink Speed", Range(0.01, 5)) = 0.6
        _BlinkAmplitude ("Blink Amplitude", Range(0, 1)) = 0.4
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_TARGET
            {
                ...
                float blink = sin(_Time.y * _BlinkSpeed * 6.28318) * 0.5 + 0.5;
                blink = lerp(1.0 - _BlinkAmplitude, 1.0, blink);

                half3 rgb = col.rgb + emission;
                half alpha = col.a;

                return half4(rgb, alpha * blink);
            }
            ENDHLSL
        }
    }
